...
public class LogicalOperator_SingleAmpersent {
...
//        System.out.println(  9/0 ==3    );
        ...
        //&& this goes first then || then this

        System.out.println( (5>10  || -3!=3  &&  8/2<10) );
        System.out.println(  5>10 &&  9/0 ==3  );
        System.out.println(  5>10 &  9/0 ==3  );
        System.out.println( (5>10  || -3!=3  &&  8/2<10) ); //bunu yazanok cunku bir onceki error
