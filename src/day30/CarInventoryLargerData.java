...
public class CarInventoryLargerData {
    public static void main(String[] args) {
        ...
        //print each location of CIVIC
        //when you work in each and every time DO NOT tunr to the string
        //just turn it if you want to print

        for (int i = 0; i < cars.length; i++) {
            if (cars[i].contains("Civic")) {
                // System.out.println(cars[i].toUpperCase().indexOf("civic"));DO NOT USE THIS !!!!!
                System.out.println("Civic found at the location: " + i);

            }
        }
        // what if it is exactly Honda-civic

        for (int i = 0; i < cars.length; i++) {
            if (cars[i].equals("Honda-Civic")) {
                System.out.println("Civic was found at the location: " + i);
            }
...
//            System.out.println("Car make is "+ eachCarSplitted[0] + " and model is "+ eachCarSplitted[1]);
            ...
            for (String eachCar : cars) {
                ...
                // so we used starts with method to check the car brand

                if (eachCar.startsWith("Porsche")) {
                    //System.out.println("eachCar = " + eachCar);
                    //we used split to split model from make
                    String[] eachCarSplitted = eachCar.split("-");
                    System.out.println("Car make is " + eachCarSplitted[0] + " and model is " + eachCarSplitted[1]);
                }
            }
            // find all the car with model has only 2 char
            //logic: first get cars.length ==2
            // pint them out
            // get the count
        }
        System.out.println("Car with only two char =====================");

        int counterOf2CharModel = 0;

        for (String eachCar : cars) {
            //we need to split it right away
        ...
        System.out.println("counterOf2CharModel = " + counterOf2CharModel);
