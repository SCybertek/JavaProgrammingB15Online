...
public class MethoWithReturnIntro {
...
//       System.out.println("myResult = " + myResult);
        ...
        add2Numbers(23,1);// we cannot do this.. why???

        int add14to16Result = add2Numbers(14,16);
        System.out.println("add14to16Result = " + add14to16Result);
        System.out.println(add2Numbers(4,7)+5);


        System.out.println(add2Numbers(23,1));

    }
    // create a method called add, accept 2 int parameters
