...
public class GroceryActions {
    ...
    *   ask user whats the price of banana and store it
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Your total price for potato is "+ dollarSign+ potatoPrice*potatoCount);

        System.out.println("What is the price of tomato?");
        float tomatoPrice = scan.nextFloat();
        System.out.println("How many you want to buy? ");
        int tomatoCount= scan.nextInt();
        System.out.println("Your total price for tomato is "+ dollarSign+ tomatoCount*tomatoPrice);

        System.out.println("What is the price of banana?");
        float bananaPrice = scan.nextFloat();
        System.out.println("How many you want to buy? ");
        int bananaCount= scan.nextInt();
        System.out.println("Your total price for banana is "+ dollarSign+ bananaPrice*bananaCount);



        System.out.println("You spend " + dollarSign+ (potatoPrice*potatoCount+tomatoPrice*tomatoCount+bananaPrice*bananaCount));
    }
}
