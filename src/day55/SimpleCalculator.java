...
public class SimpleCalculator {
    ...
    public SimpleCalculator addNum (int num) {
        ...
        //this . is this current result

        //template does not care about your name / only it uses the variable you created
        //here this. is showing the current object ! what has the current object? it has the field called num!
...
//        return; c;
        ...
        return this; // means the CURRENT OBJECT
        //WE CAN NEVER DO RETURN SUPER!!!
    }
    ...
    //final action to display the result :
