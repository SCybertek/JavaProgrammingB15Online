...
public class ExceptionPractice {
    ...
    public static void main(String[] args) {
        ...
        try {
            System.out.println(name.charAt(targetIndex)); // no matter what code will come to this line!
            //if there is an exeption we go to CATCH block -- the objcet is being created in here! from java lang the appropriate exception class!
            //it gets assigned to variable e - line28!! (Exception e = new StringIndexOutOfBoundsException (); )!!!polymorphism
            //if no abnormal situation happening then catch block without printing
        ...
        } catch (StringIndexOutOfBoundsException e) {//specify your exception! to deffinetly know what is happenning in your code
