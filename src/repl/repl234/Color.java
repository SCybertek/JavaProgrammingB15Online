package repl.repl234;

import day27.ArrayReview;
...
// below are constant field.
    ...
    public String toString() {
        ...
        //TODO
        // here we put condition . if rgb ( values of colors ) is equal to already predefined color codes in Static Final Field then we print the color
        if (Arrays.equals(rgb, LIGHT_GRAY)) {
            ...
            return "white" ; // forgot to put white first thats why it was giving n/a for default
        } else {
            return "n/a" ;
        }
